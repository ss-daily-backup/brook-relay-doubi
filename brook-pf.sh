...
Download_brook(){
	...
	cd ${file}
	if [[ ${bit} == "x86_64" ]]; then
		wget -N -O "brook" "https://github.com/ss-daily-backup/releases-backup/raw/master/brook/v20200201/20200417-130339-brook"
	else
		wget -N -O "brook" "https://github.com/ss-daily-backup/releases-backup/raw/master/brook/v20200201/20200417-130339-brook_linux_386"
	fi
